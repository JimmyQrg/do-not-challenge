...
const cardData = [
  ...
  { en: "DO NOT SAY YOUR NAME", zh: "不要说名字", jp: "名前を言わないでください" },
  ...
  { en: "DO NOT POINT AT ANYONE", zh: "不要指人", jp: "誰かを指さない" },
  { en: "DO NOT PICK UP OBJECTS", zh: "不要捡东西", jp: "物を拾わない" },
  { en: "DO NOT CLAP HANDS", zh: "不要拍手", jp: "手を叩かない" },
  { en: "DO NOT TURN YOUR HEAD", zh: "不要转头", jp: "頭を回さない" },
  { en: "DO NOT USE NOUNS REPEATEDLY", zh: "不要重复使用名词", jp: "名詞を繰り返して使わない" },
  { en: "DO NOT TOUCH OTHER PLAYERS", zh: "不要触碰其他玩家", jp: "他のプレイヤーに触れない" },
  { en: "DO NOT MOVE YOUR SHOULDER", zh: "不要动肩膀", jp: "肩を動かさない" },
  { en: "DO NOT SAY NEGATIVE WORDS", zh: "不要说消极的话", jp: "ネガティブな言葉を言わない" },
  { en: "DO NOT STAND STILL FOR 10 SECONDS", zh: "不要静止超过10秒", jp: "10秒以上静止しない" },
  { en: "DO NOT CLOSE YOUR EYES", zh: "不要闭眼", jp: "目を閉じない" },
  { en: "DO NOT CROSS ARMS", zh: "不要交叉手臂", jp: "腕を組まない" },
  { en: "DO NOT MOVE YOUR EYEBROWS", zh: "不要动眉毛", jp: "眉毛を動かさない" },
  { en: "DO NOT LOOK AT YOUR OWN RULE", zh: "不要查看自己的规则", jp: "自分のルールを見ない" },
  { en: "DO NOT USE ANY WRITING TOOLS", zh: "不要使用任何书写工具", jp: "筆記用具を使わない" },
  { en: "DO NOT TOUCH FACE", zh: "不要摸脸", jp: "顔に触れない" },
  { en: "DO NOT LEAN BACK", zh: "不要向后靠", jp: "後ろに寄りかからない" },
  { en: "DO NOT SHAKE YOUR HANDS", zh: "不要握手", jp: "握手しない" },
  { en: "DO NOT SING", zh: "不要唱歌", jp: "歌わない" },
  { en: "DO NOT SPEAK WITHOUT BREATHING", zh: "不要连续说话不呼吸", jp: "呼吸せずに話さない" },
